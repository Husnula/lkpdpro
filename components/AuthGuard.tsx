  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      if (user) {
        ...
        const role = ["jagofeed@gmail.com", "jagofeedmediatama@gmail.com", "bapakeathfar@gmail.com"].includes(user.email || "") ? "super-admin" : "user";
        ...
        try {
          ...
          if (user.email && ["jagofeed@gmail.com", "jagofeedmediatama@gmail.com", "bapakeathfar@gmail.com"].includes(user.email)) {
